...
import { EmailTeamTemplate } from "./email-template";
...
const YourNextStep = () => {
  ...
  return (
    <Card sx={{ p: 2 }}>
      ...
      >
        <Typography variant="subtitle1">Your Next Step</Typography>
        <Box>
          <Button
            variant="outlined"
            sx={{ marginRight: 3 }}
      ...
      <Typography variant="subtitle2" sx={{ color: "text.secondary", my: 2 }}>
        Invite your new to Personnel Library Onboarding, with a summary of who
        their manager is, what tasks they have to complete, and any custom text.
      </Typography>
      <CustomTable
        data={TableMockData}
        columns={columns}
