  ...
  return (
    <SvgIcon sx={{ width, height, ...sx }}>
      ...
      >
        ...
        />
        <path
          d="M12.0019 9.99982C13.2887 9.99982 14.3319 8.95662 14.3319 7.6698C14.3319 6.38298 13.2887 5.33984 12.0019 5.33984C10.7151 5.33984 9.67188 6.38298 9.67188 7.6698C9.67188 8.95662 10.7151 9.99982 12.0019 9.99982Z"
          stroke="#98A2B3"
        />
        <path
