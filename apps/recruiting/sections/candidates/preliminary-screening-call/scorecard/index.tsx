...
const statusButton = ["not requested", "no", "yes", "strong yes"];
export function PreliminaryScoreCardSection(): JSX.Element {
    ...
    >
      ...
      <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
        ...
        >
          ...
          <Typography variant="caption" mb={1} color={theme.palette.grey[400]}>
          ...
          <Grid container gap={2.5}>
            {statusButton?.map((ele) => (
              <Button
                key={ele}
                variant="outlined"
                sx={{ width: 220, border: ele === status ? "2px solid" : "" }}
                onClick={() => {
