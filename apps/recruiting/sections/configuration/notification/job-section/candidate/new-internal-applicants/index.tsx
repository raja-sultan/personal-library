...
export function NewInternalApplicantsModal({
  isOpen,
  closeModel,
  jobId,
}: any): JSX.Element {
  ...
  const onSubmit = handleSubmit(async (data: any) => {
    ...
    try {
      const res: any = await updateNotifications({
        body: {
          notificationFor: "newInternalApplicants",
          users,
        },
        jobId,
      }).unwrap();
  ...
  return (
    <CustomModal
      ...
      onClose={closeModel}
      headerLabel="New Internal Applicants"
        ...
        <Grid container>
          <Grid item xs={12} mt={1}>
            ...
            <Typography variant="subtitle2">
              For each new internal Applicants that applies to this job, emails will be
