...
export function NewApplicantModal({
  isOpen,
  closeModel,
  jobId,
}: any): JSX.Element {
        ...
        <Grid container>
          <Grid item xs={12} mt={1}>
            ...
            <Typography variant="subtitle2">
              For each new Applicants that applies to this job, emails will be
