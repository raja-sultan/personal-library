...
import {
  ...
  creatingAreaOptions,
  filtersData,
} from "./prospect-conversion-data";
import ReactApexChart from "react-apexcharts";
import useProspectConversion from "./use-prospect-conversion";

function ProspectConversionSection(): JSX.Element {
  const {
    data,
    isError,
    isFetching,
...
export default ProspectConversionSection;
