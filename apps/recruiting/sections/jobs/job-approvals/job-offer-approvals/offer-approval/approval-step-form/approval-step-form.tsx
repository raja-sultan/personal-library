...
export function ApprovalStepForm({ closeModel }): JSX.Element {
  const { addUsersTodNdUsersForOfferApproval, dNdUsersForOfferApproval } =
  ...
  const userListForApprovalsDefValues = dNdUsersForOfferApproval.map(
    (user) => ({
  ...
  const onSubmit = (formData): any => {
    ...
    addUsersTodNdUsersForOfferApproval(numOfApprovalRequired, transFormData);
    closeModel();
  };
