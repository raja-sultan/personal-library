...
import { ApprovalModalFormSchema } from "./approvals-step.schema";
...
export function AddApprovalStepModal({
  ...
  // const approvalSteps = addApprovalData?.approvalSteps;
  ...
  const approvalLength = watch("fullName");

  //Submit Function
  const onSubmit = async (data: any) => {
    const updatedApproval = data?.fullName.map(({ userName, ...reset }) => {
      return {
