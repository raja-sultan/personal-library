...
export function ViewEventDetail(): JSX.Element {
    ...
    <Box sx={{ mt: 2, backgroundColor: "white", p: 2, borderRadius: 1 }}>
      ...
      <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
        <Grid container spacing={2}>
          ...
          <Grid item xl={4} lg={6} xs={12}>
            <Typography variant="body1" sx={{ fontWeight: 600 }}>
              https://s101.recruiting.eu.Personnel Library.io/e/marqxj
            </Typography>
              ...
              >
                <Box
                  sx={{
                    ...
                    height: "50px",
                    borderRadius: 1,
                    border: "2px solid #a2cefd",
                  }}
                >
                  <AttachmentIcon
                    sx={{ color: "#2e90fa", transform: "rotate(45deg)" }}
                  />
                </Box>
              </Box>
              <Box sx={{ ml: 2 }}>
                <Typography
                  variant="body1"
                  sx={{ color: "#2E90FA", fontWeight: "500" }}
                >
                  What is this URL for?
                </Typography>
                <Typography>
                  Share it with prospects during your event so they can fill out
                  the form from their own devices. Learn More
                </Typography>
              </Box>
            </Box>
          </Grid>
