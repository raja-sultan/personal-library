import type { profileDataProps } from "./profile.types";
...
export const infoData = (data) => [
  { icon: <EmailIcon />, title: "Email", content: data?.email },
  { icon: <PhoneNumberIcon />, title: "Contact Number", content: data?.contactNumber },
  {
    icon: <ClockIcon />,
    title: "Employment Start Time",
    content: dayjs(data?.employmentStartDate).format("hh:mm A"),
  },
];
...
export const profileData: profileDataProps = {
  profileReviewsData: [
    ...
    { id: 2, title: "Marketing Team Q1 Review", status: "ended", buttonText: "Select peers" },
  ],
  profileGoalsData: [
    { id: 1, title: "Consulting Services Project", status: "on track", percentage: "20%" },
    { id: 2, title: "Marketing Team Q1 Review", status: "off track", percentage: "2%" },
  ],
  profileGrowthAreas: [
    {
      id: 1,
