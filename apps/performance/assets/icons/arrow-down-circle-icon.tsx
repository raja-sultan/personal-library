...
export function ArrowDownCircleIcon(props: IconProps): JSX.Element {
  ...
  return (
    <SvgIcon sx={{ width, height, ...sx }} onClick={onClick}>
      ...
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M8.46875 10.74L11.9987 14.26L15.5287 10.74" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </SvgIcon>
  );
}
