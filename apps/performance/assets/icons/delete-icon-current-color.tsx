...
export function DeleteIconCurrentColor(props: IconProps): JSX.Element {
    const { width = "24px", height = "24px", sx = {}, onClick } = props;
    ...
    return (
        <SvgIcon sx={{ width, height, ...sx }} onClick={onClick}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M18.8484 9.14062L18.1984 19.2106C18.0884 20.7806 17.9984 22.0006 15.2084 22.0006H8.78844C5.99844 22.0006 5.90844 20.7806 5.79844 19.2106L5.14844 9.14062" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
