...
import { TableAction, CustomChip, TableHeader, CustomTable } from "common";
import { Box } from "@mui/material";
import ScheduleADemoFrom from "./schedule-a-demo-from";
import { CreateCompanyUserFrom } from "./create-company-user-form";
...
export function NewRequestTable(): JSX.Element {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (info: any) => (
        <Box>
          <TableAction>
            <ScheduleADemoFrom apiData={info.row.original} />
            <CreateCompanyUserFrom
              apiData={info.row.original}
              submitLabel="Create Company user"
            />
          </TableAction>
        </Box>
      ),
