...
import { useLazyUsersQuery } from "@root/services/json-placeholder-api";
import {
  Button,
  Checkbox,
  Stack,
...
const FormSchema = Yup.object().shape({
  ...
  customSelect: Yup.string().required("Select atleast one"),
});
    ...
    <>
      ...
      <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
        <Stack sx={{ maxWidth: 400, gap: 2, mt: 2, mx: "auto" }}>
          ...
          <RHFCustomSelect
            name="customSelect"
            outerLabel="Custom Select (By FaisaL)"
            placeholder="Sync autocomplete Multi"
            options={[
              { id: 1, label: "test", value: "test" },
              { id: 2, label: "pest", value: "pest" },
            ]}
          />
