...
import type { ProfileDataComponentsTypes } from "./types";
import { myProfileData } from "./profile.data";
import { LoadingButton } from "@mui/lab";

export function ProfileData(props: ProfileDataComponentsTypes): JSX.Element {
  const { editFormState, setEditFormState, isLoading } = props;
